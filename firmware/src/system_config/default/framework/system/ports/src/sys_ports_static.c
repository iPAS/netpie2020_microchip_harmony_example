...
void SYS_PORTS_Initialize(void)
{
    ...
    /* PPS Input Remapping */
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_U2RX, INPUT_PIN_RPC3 );
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_U6RX, INPUT_PIN_RPB2 );
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_SDI1, INPUT_PIN_RPC1 );
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_INT1, INPUT_PIN_RPF3 );

    /* PPS Output Remapping */
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_U2TX, OUTPUT_PIN_RPC2 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_U6TX, OUTPUT_PIN_RPE9 );
